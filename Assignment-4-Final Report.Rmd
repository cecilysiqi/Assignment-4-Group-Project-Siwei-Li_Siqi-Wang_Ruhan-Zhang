...
According to the acf plot, the correlation problem solved faster for $c\geqslant 2.5$. The acf is still too large after lag 40 for $c=0.1$. This penomena indicates that the Markov Chain would converge faster as c increases. Thus it is the best to use $c=10$.
